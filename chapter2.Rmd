...
```
#### About the data
"learn" is a dataset of 166 students, with variables "gender", "age", "attitude", "points", depe, stra, surf. Last three are scales measuring different aspects of learning  (deep, strategic or surface learning). The students scoring 0 points on exam are not included.
